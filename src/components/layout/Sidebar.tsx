...
export const Sidebar: React.FC<SidebarProps> = ({ mobileOpen, setMobileOpen }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar Container */}
      <aside
        className={`fixed top-0 bottom-0 left-0 z-40 w-64 bg-slate-900 border-r border-slate-800 text-slate-300 flex flex-col transition-transform duration-300 ease-in-out lg:translate-x-0 ${
      ...
      >
        ...
        <div className="p-5 border-b border-slate-800/80 flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-[11px] text-slate-400 truncate">Express Retail Terminal</p>
          </div>
        </div>
        ...
        {lowStockCount > 0 && (
          <div className="mx-3 my-2 p-3 bg-amber-950/40 border border-amber-800/50 rounded-xl flex items-center gap-2.5">
            <AlertTriangle className="w-4 h-4 text-amber-400 shrink-0" />
            <div className="text-xs min-w-0 flex-1">
              <p className="text-amber-200 font-semibold">{lowStockCount} items low in stock</p>
              <button
        ...
        <div className="p-3 border-t border-slate-800/80 space-y-1 text-xs">
          <button
            ...
            className="w-full flex items-center justify-between px-3 py-2 text-slate-400 hover:text-slate-200 hover:bg-slate-800/60 rounded-xl transition-colors"
          >
          ...
          <button
            ...
            className="w-full flex items-center gap-2 px-3 py-2 text-slate-400 hover:text-rose-300 hover:bg-rose-950/30 rounded-xl transition-colors text-left"
          >
